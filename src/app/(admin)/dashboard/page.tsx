...
export default function DashboardPage() {
  ...
  return (
    <div>
      <PageHeader title="Dashboard" description="Fleet overview, reservations, and financial performance." />
      ...
      {isPending ? (
        ...
        <>
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 xl:grid-cols-4">
            ...
            <StatCard label="Pending reservations" value={stats.global_kpis.pending_reservations} />
            <StatCard label="Pending alerts" value={stats.global_kpis.pending_alerts} />
          </div>

          <div className="mt-6 grid grid-cols-1 gap-4 sm:grid-cols-2 xl:grid-cols-4">
            <StatCard label="Monthly revenue" value={formatCurrency(stats.global_kpis.monthly_revenue)} />
            <StatCard label="Monthly expenses" value={formatCurrency(stats.global_kpis.monthly_expenses)} />
